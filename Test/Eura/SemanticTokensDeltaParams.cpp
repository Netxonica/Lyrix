...
{
    const std::string content = "{\"workDoneToken\":\"meow\",\"partialResultToken\":\"meow\",\"textDocument\":{\"uri\":\"meow.extension\"},\"previousResultId\":\"nya\"}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::SemanticTokensDeltaParams request;
    ...
    request.textDocument.uri not_eq "meow.extension" or request.previousResultId not_eq "nya")
        return false;
