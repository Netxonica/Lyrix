...
{
    const std::string content = "{\"notebookSelector\":[{\"notebook\":{\"notebookType\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},\"cells\":[{\"language\":\"lyrix\"}]}],\"save\":true,\"id\":\"meow\"}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::NotebookDocumentSyncRegistrationOptions request;
    ...
    "lyrix" or not request.save.has_value() or not *request.save or not request.id.has_value() or *
