...
{
    const std::string content = "{\"workDoneProgress\":true,\"resolveProvider\":true,\"documentSelector\":[{\"language\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},{\"notebook\":{\"notebookType\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},\"language\":\"lyrix\"}],\"id\":\"meow\"}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::InlayHintRegistrationOptions request;
    Eura::from_json(root, request);
    if(not request.workDoneProgress.has_value() or not *request.workDoneProgress or not request.
    resolveProvider.has_value() or not *request.resolveProvider or not std::holds_alternative<Eura
