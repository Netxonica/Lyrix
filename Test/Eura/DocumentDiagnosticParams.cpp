...
{
    const std::string content = "{\"workDoneToken\":\"meow\",\"partialResultToken\":\"meow\",\"textDocument\":{\"uri\":\"meow.extension\"},\"identifier\":\"meow\",\"previousResultId\":\"nya\"}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::DocumentDiagnosticParams request;
    ...
    request.textDocument.uri not_eq "meow.extension" or not request.identifier.has_value() or *
    request.identifier not_eq "meow" or not request.previousResultId.has_value() or *request.
    previousResultId not_eq "nya")
        return false;
