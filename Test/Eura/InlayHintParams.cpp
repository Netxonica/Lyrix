...
{
    const std::string content = "{\"workDoneToken\":\"meow\",\"textDocument\":{\"uri\":\"meow.extension\"},\"range\":{\"start\":{\"line\":0,\"character\":0},\"end\":{\"line\":42,\"character\":67}}}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::InlayHintParams request;
