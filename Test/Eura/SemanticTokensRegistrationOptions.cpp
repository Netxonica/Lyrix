...
{
    const std::string content = "{\"documentSelector\":[{\"language\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},{\"notebook\":{\"notebookType\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},\"language\":\"lyrix\"}],\"workDoneProgress\":true,\"legend\":{\"tokenTypes\":[\"meow\"],\"tokenModifiers\":[\"nya\"]},\"range\":{},\"full\":{\"delta\":true},\"id\":\"meow\"}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::SemanticTokensRegistrationOptions request;
    ...
    request.workDoneProgress.has_value() or not *request.workDoneProgress or request.legend.
    ...
    full);
    if(not full.delta.has_value() or not *full.delta or not request.id.has_value() or *request.id
    not_eq "meow")
        return false;
