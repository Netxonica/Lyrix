...
{
    const std::string content = "{\"textDocument\":{\"uri\":\"meow.extension\"},\"position\":{\"line\":42,\"character\":67},\"workDoneToken\":\"meow\"}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::CallHierarchyPrepareParams request;
