...
{
    const std::string content = "{\"documentSelector\":[{\"language\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},{\"notebook\":{\"notebookType\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},\"language\":\"lyrix\"}],\"syncKind\":2}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::TextDocumentChangeRegistrationOptions request;
    ...
    language.has_value() or *notebook_cell_text_document_filter.language not_eq "lyrix" or request.
    syncKind not_eq Eura::TextDocumentSyncKind::Incremental)
        return false;
