...
{
    const std::string content = "{\"textDocument\":{\"uri\":\"meow.extension\"},\"position\":{\"line\":42,\"character\":67},\"workDoneToken\":\"meow\",\"partialResultToken\":\"meow\",\"context\":{\"includeDeclaration\":true}}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::ReferenceParams request;
    ...
    partialResultToken) not_eq "meow" or not request.context.includeDeclaration)
        return false;
