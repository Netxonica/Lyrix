...
{
    const std::string content = "{\"range\":{\"start\":{\"line\":0,\"character\":0},\"end\":{\"line\":42,\"character\":67}},\"newText\":\"meow nya\",\"annotationId\":\"meow\"}";
    ...
    "meow nya" or request.annotationId not_eq "meow")
        return false;
