...
{
    const std::string content = "{\"documentSelector\":[{\"language\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},{\"notebook\":{\"notebookType\":\"lyrix\",\"scheme\":\"meow.lyrix\",\"pattern\":{\"baseUri\":{\"uri\":\"meow.extension\",\"name\":\"meow nya\"},\"pattern\":\"*.extension\"}},\"language\":\"lyrix\"}],\"id\":\"meow\",\"workDoneProgress\":true}";
    const nlohmann::json root = nlohmann::json::parse(content);
    Eura::DocumentColorRegistrationOptions request;
    ...
    request.id.has_value() or *request.id not_eq "meow" or not request.workDoneProgress.has_value()
    or not *request.workDoneProgress)
        return false;
