...
#ifndef lyrix_header_guard_eura_document_formatting_client_capabilities
#define lyrix_header_guard_eura_document_formatting_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] DocumentFormattingClientCapabilities final
    {
