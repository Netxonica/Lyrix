...
#ifndef lyrix_header_guard_eura_declaration_params
#define lyrix_header_guard_eura_declaration_params
...
namespace Eura
{
    struct [[nodiscard]] DeclarationParams final : TextDocumentPositionParams,
