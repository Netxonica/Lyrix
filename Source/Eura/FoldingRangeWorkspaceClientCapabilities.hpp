...
#ifndef lyrix_header_guard_eura_folding_range_workspace_client_capabilities
#define lyrix_header_guard_eura_folding_range_workspace_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] FoldingRangeWorkspaceClientCapabilities final
    {
