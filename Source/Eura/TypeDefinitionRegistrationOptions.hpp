...
#ifndef lyrix_header_guard_eura_type_definition_registration_options
#define lyrix_header_guard_eura_type_definition_registration_options
...
namespace Eura
{
    struct [[nodiscard]] TypeDefinitionRegistrationOptions final : TextDocumentRegistrationOptions,
    TypeDefinitionOptions, StaticRegistrationOptions{};
