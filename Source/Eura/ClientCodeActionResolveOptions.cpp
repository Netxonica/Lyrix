...
namespace Eura
{
    ...
    client_code_action_resolve_options) noexcept -> void
    {
        ...
        for(const nlohmann::json& property : properties)
            client_code_action_resolve_options.properties.emplace_back(property.get<std::string>())
            ;
    }
    ...
    client_code_action_resolve_options) noexcept -> void
    {
        ...
        for(const std::string& property : client_code_action_resolve_options.properties)
