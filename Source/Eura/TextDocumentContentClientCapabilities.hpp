...
#ifndef lyrix_header_guard_eura_text_document_content_client_capabilities
#define lyrix_header_guard_eura_text_document_content_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] TextDocumentContentClientCapabilities final
    {
