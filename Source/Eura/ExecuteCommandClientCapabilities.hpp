...
#ifndef lyrix_header_guard_eura_execute_command_client_capabilities
#define lyrix_header_guard_eura_execute_command_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] ExecuteCommandClientCapabilities final
    {
