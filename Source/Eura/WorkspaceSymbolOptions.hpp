...
#ifndef lyrix_header_guard_eura_workspace_symbol_options
#define lyrix_header_guard_eura_workspace_symbol_options
#include "Eura/WorkDoneProgressOptions.hpp"

namespace Eura
{
    struct [[nodiscard]] WorkspaceSymbolOptions final : WorkDoneProgressOptions
    {
