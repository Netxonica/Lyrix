...
#ifndef lyrix_header_guard_eura_folding_range_params
#define lyrix_header_guard_eura_folding_range_params
...
namespace Eura
{
    struct [[nodiscard]] FoldingRangeParams final : WorkDoneProgressParams, PartialResultParams
    {
