...
#ifndef lyrix_header_guard_eura_diagnostic_registration_options
#define lyrix_header_guard_eura_diagnostic_registration_options
...
namespace Eura
{
    struct [[nodiscard]] DiagnosticRegistrationOptions final : TextDocumentRegistrationOptions,
