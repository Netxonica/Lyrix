...
#ifndef lyrix_header_guard_eura_inline_value_client_capabilities
#define lyrix_header_guard_eura_inline_value_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] InlineValueClientCapabilities final
    {
