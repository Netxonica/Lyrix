...
#ifndef lyrix_header_guard_eura_client_folding_range_kind_options
#define lyrix_header_guard_eura_client_folding_range_kind_options
#include "Eura/Json.hpp"
#include "Eura/FoldingRangeKind.hpp"

namespace Eura
{
    struct [[nodiscard]] ClientFoldingRangeKindOptions final
    {
