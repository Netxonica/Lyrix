...
#ifndef lyrix_header_guard_eura_client_code_lens_resolve_options
#define lyrix_header_guard_eura_client_code_lens_resolve_options
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] ClientCodeLensResolveOptions final
    {
