...
#ifndef lyrix_header_guard_eura_type_hierarchy_client_capabilities
#define lyrix_header_guard_eura_type_hierarchy_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] TypeHierarchyClientCapabilities final
    {
