...
#ifndef lyrix_header_guard_eura_related_full_document_diagnostic_report
#define lyrix_header_guard_eura_related_full_document_diagnostic_report
#include "Eura/FullDocumentDiagnosticReport.hpp"
#include "Eura/UnchangedDocumentDiagnosticReport.hpp"

namespace Eura
{
    struct [[nodiscard]] RelatedFullDocumentDiagnosticReport final : FullDocumentDiagnosticReport
    {
