...
#ifndef lyrix_header_guard_eura_declaration_registration_options
#define lyrix_header_guard_eura_declaration_registration_options
...
namespace Eura
{
    struct [[nodiscard]] DeclarationRegistrationOptions final : DeclarationOptions,
