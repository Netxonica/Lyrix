...
#ifndef lyrix_header_guard_eura_linked_editing_range_params
#define lyrix_header_guard_eura_linked_editing_range_params
#include "Eura/WorkDoneProgressParams.hpp"
#include "Eura/TextDocumentPositionParams.hpp"

namespace Eura
{
    struct [[nodiscard]] LinkedEditingRangeParams final : TextDocumentPositionParams,
