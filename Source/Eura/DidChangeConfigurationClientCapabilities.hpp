...
#ifndef lyrix_header_guard_eura_did_change_configuration_client_capabilities
#define lyrix_header_guard_eura_did_change_configuration_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] DidChangeConfigurationClientCapabilities final
    {
