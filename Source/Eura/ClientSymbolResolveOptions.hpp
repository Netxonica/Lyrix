...
#ifndef lyrix_header_guard_eura_client_symbol_resolve_options
#define lyrix_header_guard_eura_client_symbol_resolve_options
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] ClientSymbolResolveOptions final
    {
