...
#ifndef lyrix_header_guard_eura_inlay_hint_registration_options
#define lyrix_header_guard_eura_inlay_hint_registration_options
...
namespace Eura
{
    struct [[nodiscard]] InlayHintRegistrationOptions final : InlayHintOptions,
