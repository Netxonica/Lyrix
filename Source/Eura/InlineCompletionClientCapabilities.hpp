...
#ifndef lyrix_header_guard_eura_inline_completion_client_capabilities
#define lyrix_header_guard_eura_inline_completion_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] InlineCompletionClientCapabilities final
    {
