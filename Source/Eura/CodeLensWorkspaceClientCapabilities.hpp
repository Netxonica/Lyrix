...
#ifndef lyrix_header_guard_eura_code_lens_workspace_client_capabilities
#define lyrix_header_guard_eura_code_lens_workspace_client_capabilities
#include "Eura/Json.hpp"

namespace Eura
{
    struct [[nodiscard]] CodeLensWorkspaceClientCapabilities final
    {
