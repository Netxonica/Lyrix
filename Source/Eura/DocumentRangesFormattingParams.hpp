...
#ifndef lyrix_header_guard_eura_document_ranges_formatting_params
#define lyrix_header_guard_eura_document_ranges_formatting_params
...
namespace Eura
{
    struct [[nodiscard]] DocumentRangesFormattingParams final : WorkDoneProgressParams
    {
